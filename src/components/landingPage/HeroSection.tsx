    ...
    <section className="w-full relative overflow-hidden min-h-screen flex flex-col items-center justify-center ">
      ...
      <div className="group relative mx-auto flex items-center justify-center rounded-full px-4 py-1.5 shadow-[inset_0_-8px_10px_#8fdfff1f] transition-shadow duration-500 ease-out hover:shadow-[inset_0_-5px_10px_#8fdfff3f]">
        ...
        <ChevronRight className="ml-1 size-4 stroke-neutral-500 transition-transform duration-300 ease-in-out group-hover:translate-x-0.5" />
            ...
            <h1 className="text-6xl sm:text-4xl md:text-5xl lg-text-6xl font-extrabold tracking-tighter">Transform your photos with the power of AI</h1>

            <p className="mx-auto max-w-3xl md:text-xl sm:text-lg xs:text-base mb-8 text-grey-600">
            ...
            <div className="flex items-center spacec-x-2 mb-4">
                ...
                <span className="text-sm font-md ml-2">Loved by 1k+ customers</span>
