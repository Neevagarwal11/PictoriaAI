...
const ReviewCard = ({
  ...
  return (
    <figure
      className={cn(
        "relative h-full w-80 cursor-pointer overflow-hidden rounded-xl border sm:p-8 flex flex-col justify-between p-4",
        // light styles
...
function Testimonials() {
  return (
    ...
    >
      ...
      <h2 className="subHeading mt-10">What Our Users Say</h2>
      ...
      {/* Testimonial Marquee */}
      <div className="relative flex w-full flex-col mt-16 items-center justify-center overflow-hidden">
      ...
      <div className="from-background pointer-events-none absolute inset-y-0 left-0 sm:w-1/4 bg-gradient-to-r"></div>
      <div className="from-background pointer-events-none absolute inset-y-0 right-0 sm:w-1/4 bg-gradient-to-l"></div>
    </div>
